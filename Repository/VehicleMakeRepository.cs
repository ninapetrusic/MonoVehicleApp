...
{
    public class VehicleMakeRepository : GenericRepository<DAL.VehicleMake>, IVehicleMakeRepository
    {
        public VehicleMakeRepository(IMapper _mapper, VehicleContext context) : base(context, _mapper)
        {
        }

        public override async Task<IEnumerable<VehicleMake>> GetAllAsync(QueryParams queryParams)
        {
